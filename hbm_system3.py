...
# google sheets setup
sa = gspread.service_account(filename="D:/arjun/hospital system/service_account.json")
...
def head():
    ...
    # importing photos
    logo = PhotoImage(file="D:/arjun/hospital system/logo.png")
    blank = PhotoImage(file="D:/arjun/hospital system/blank.png")
    acc_logo = PhotoImage(file="D:/arjun/hospital system/4.png")
    # acc_logo2 = PhotoImage(file="D:/arjun/hospital system/5.png")
    account = PhotoImage(file="D:/arjun/hospital system/1.png")
    about = PhotoImage(file="D:/arjun/hospital system/2.png")
    contact_us = PhotoImage(file="D:/arjun/hospital system/3.png")
    about_logo = PhotoImage(file="D:/arjun/hospital system/8.png")
    # about_logo2 = PhotoImage(file="D:/arjun/hospital system/9.png")
    contact_logo = PhotoImage(file="D:/arjun/hospital system/7.png")
    # contact_logo2 = PhotoImage(file="D:/arjun/hospital system/6.png")
    mtl_logo = PhotoImage(file="D:/arjun/hospital system/18.png")
    main_banner = PhotoImage(file="D:/arjun/hospital system/27.png")
    bed1 = PhotoImage(file="D:/arjun/hospital system/31.png")
    bed2 = PhotoImage(file="D:/arjun/hospital system/32.png")
    refresh = PhotoImage(file="D:/arjun/hospital system/30.png")
...
def login():
    ...
    banner_login = PhotoImage(file="D:/arjun/hospital system/10.png")
    arrow = PhotoImage(file="D:/arjun/hospital system/17.png")
    user_pass = PhotoImage(file="D:/arjun/hospital system/12.png")
    close_button = PhotoImage(file="D:/arjun/hospital system/13.png")
    login_btn = PhotoImage(file="D:/arjun/hospital system/14.png")
    grad = PhotoImage(file="D:/arjun/hospital system/15.png")
    wrn2 = PhotoImage(file="D:/arjun/hospital system/22.png")
    wrn1 = PhotoImage(file="D:/arjun/hospital system/26.png")
    acc_logo2 = PhotoImage(file="D:/arjun/hospital system/33.png")
    acc_logo = PhotoImage(file="D:/arjun/hospital system/4.png")
...
def my_self():
    ...
    banner_login = PhotoImage(file="D:/arjun/hospital system/19.png")
    arrow = PhotoImage(file="D:/arjun/hospital system/17.png")
    close_button = PhotoImage(file="D:/arjun/hospital system/13.png")
    grad = PhotoImage(file="D:/arjun/hospital system/15.png")
    hello = PhotoImage(file="D:/arjun/hospital system/20.png")
    face = PhotoImage(file="D:/arjun/hospital system/23.png")
    logout_btn = PhotoImage(file="D:/arjun/hospital system/24.png")
    logout_btn2 = PhotoImage(file="D:/arjun/hospital system/25.png")
    acc_logo2 = PhotoImage(file="D:/arjun/hospital system/33.png")
    acc_logo = PhotoImage(file="D:/arjun/hospital system/4.png")
...
def about_win(win, frm):
    ...
    banner_login = PhotoImage(file="D:/arjun/hospital system/34.png")
    blank = PhotoImage(file="D:/arjun/hospital system/38.png")
    close_button = PhotoImage(file="D:/arjun/hospital system/37.png")
    about_logo = PhotoImage(file="D:/arjun/hospital system/8.png")
    about_logo2 = PhotoImage(file="D:/arjun/hospital system/9.png")
    main_pic = PhotoImage(file="D:/arjun/hospital system/40.png")
...
def contact_win(win, frm):
    ...
    main.overrideredirect(True)
    main.resizable(0, 0)
    banner_login = PhotoImage(file="D:/arjun/hospital system/35.png")
    close_button = PhotoImage(file="D:/arjun/hospital system/37.png")
    blank = PhotoImage(file="D:/arjun/hospital system/38.png")
    contact_logo = PhotoImage(file="D:/arjun/hospital system/7.png")
    contact_logo2 = PhotoImage(file="D:/arjun/hospital system/6.png")
    main_pic = PhotoImage(file="D:/arjun/hospital system/36.png")
